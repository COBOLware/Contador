       ...
       01  AREAS-DE-TRABALHO-1.
           05 SUG         PIC 9(002) VALUE 0.
           05 SUG-M       PIC 9(002) VALUE 0.
           05 SUG-D       PIC 9(002) VALUE 0.
       ...
       01  CB001PC.
           ...
           05 M01      LINE 13 COLUMN 12 PIC Z(002) USING CBPAPC-M01.
           05 M02      LINE 13 COLUMN 15 PIC Z(002) USING CBPAPC-M02.
           05 M03      LINE 13 COLUMN 18 PIC Z(002) USING CBPAPC-M03.
           05 M04      LINE 13 COLUMN 21 PIC Z(002) USING CBPAPC-M04.
           05 M05      LINE 13 COLUMN 24 PIC Z(002) USING CBPAPC-M05.
           05 M06      LINE 13 COLUMN 27 PIC Z(002) USING CBPAPC-M06.
           05 M07      LINE 13 COLUMN 30 PIC Z(002) USING CBPAPC-M07.
           05 M08      LINE 13 COLUMN 33 PIC Z(002) USING CBPAPC-M08.
           05 M09      LINE 13 COLUMN 36 PIC Z(002) USING CBPAPC-M09.
           05 M10      LINE 13 COLUMN 39 PIC Z(002) USING CBPAPC-M10.
           05 M11      LINE 13 COLUMN 42 PIC Z(002) USING CBPAPC-M11.
           05 M12      LINE 13 COLUMN 45 PIC Z(002) USING CBPAPC-M12.
           05 M13      LINE 13 COLUMN 48 PIC Z(002) USING CBPAPC-M13.
           05 M14      LINE 13 COLUMN 51 PIC Z(002) USING CBPAPC-M14.
           05 M15      LINE 13 COLUMN 54 PIC Z(002) USING CBPAPC-M15.
           ...
           PERFORM TEST AFTER UNTIL (CONFIRMA = "S" OR "s") OR ESC
                PERFORM TEST AFTER
                   ...
                   ELSE
                        IF   CURSOR-UP
                             IF   G > 1
                                  PERFORM TEST AFTER UNTIL G NOT > DGC
                                                        OR G = 16
                                          SUBTRACT 1 FROM G
                                  END-PERFORM
                             ELSE
       ...
       210-JANELA-DIGITO.
           ...
           DISPLAY "³" LINE 10 COLUMN 11
           DISPLAY "³" LINE 11 COLUMN 11
           DISPLAY "À" LINE 12 COLUMN 11
           MOVE 0  TO G
           MOVE 12 TO COL-V
           PERFORM DGC TIMES
                   ADD 1 TO G
                   DISPLAY "ÄÄÄ" LINE 09 COLUMN COL-V
                   DISPLAY "   " LINE 10 COLUMN COL-V
                   DISPLAY G     LINE 11 COLUMN COL-V
                   ADD 2 TO COL-V
           ...
           DISPLAY "³" LINE 10 COLUMN COL-V
           DISPLAY "³" LINE 11 COLUMN COL-V
           DISPLAY "Ù" LINE 12 COLUMN COL-V.
