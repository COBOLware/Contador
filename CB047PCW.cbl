       ...
       01  CB047PD.
           ...
           05 LINE 10 COLUMN 12 VALUE "ษอDiretขriosออออออออ".
           05 LINE 10 COLUMN 32 VALUE "ออออออออออออออออออออ".
           05 LINE 10 COLUMN 52 VALUE "อออออออออออป".
           05 LINE 11 COLUMN 12 VALUE "บ                   ".
           05 LINE 11 COLUMN 32 VALUE "                    ".
           05 LINE 11 COLUMN 52 VALUE "           บ".
           05 LINE 12 COLUMN 12 VALUE "บ Moedas    : ".
           05 LINE 12 COLUMN 62 VALUE " บ".
           05 LINE 13 COLUMN 12 VALUE "บ                   ".
           05 LINE 13 COLUMN 32 VALUE "                    ".
           05 LINE 13 COLUMN 52 VALUE "           บ".
           05 LINE 14 COLUMN 12 VALUE "บ Help      : ".
           05 LINE 14 COLUMN 62 VALUE " บ".
           05 LINE 15 COLUMN 12 VALUE "บ                   ".
           05 LINE 15 COLUMN 32 VALUE "                    ".
           05 LINE 15 COLUMN 52 VALUE "           บ".
           05 LINE 16 COLUMN 12 VALUE "บ Estruturas: ".
           05 LINE 16 COLUMN 62 VALUE " บ".
           05 LINE 17 COLUMN 12 VALUE "บ                   ".
           05 LINE 17 COLUMN 32 VALUE "                    ".
           05 LINE 17 COLUMN 52 VALUE "           บ".
           05 LINE 18 COLUMN 12 VALUE "ศอออออออออออออออออออ".
           05 LINE 18 COLUMN 32 VALUE "ออออออออออออออออออออ".
           05 LINE 18 COLUMN 52 VALUE "อออออออออออผ".
       ...
       01  CB047PE.
           ...
           05 LINE 10 COLUMN 12 VALUE "ษอTermos de abertura".
           05 LINE 10 COLUMN 32 VALUE "/encerramentoอออออออ".
           05 LINE 10 COLUMN 52 VALUE "ออออออออออออออออออออออป".
           05 LINE 11 COLUMN 12 VALUE "บ                   ".
           05 LINE 11 COLUMN 32 VALUE "                    ".
           05 LINE 11 COLUMN 52 VALUE "                      บ".
           05 LINE 12 COLUMN 12 VALUE "บ B sico : ".
           05 LINE 12 COLUMN 62 VALUE "            บ".
           05 LINE 13 COLUMN 12 VALUE "บ                   ".
           05 LINE 13 COLUMN 32 VALUE "                    ".
           05 LINE 13 COLUMN 52 VALUE "                      บ".
           05 LINE 14 COLUMN 12 VALUE "บ Editor : ".
           05 LINE 14 COLUMN 62 VALUE "            บ".
           05 LINE 15 COLUMN 12 VALUE "บ                   ".
           05 LINE 15 COLUMN 32 VALUE "                    ".
           05 LINE 15 COLUMN 52 VALUE "                      บ".
           05 LINE 16 COLUMN 12 VALUE "ศอออออออออออออออออออ".
           05 LINE 16 COLUMN 32 VALUE "ออออออออออออออออออออ".
           05 LINE 16 COLUMN 52 VALUE "ออออออออออออออออออออออผ".
           05 TELA-TERMOS
       ...
       000-INICIO.
           ...
           PERFORM TEST AFTER UNTIL WS-OPTION > 5
                   ...
                   EXEC COBOLware BoxSelect
                        ...
                        CAPTION(3)   " ~Diretขrios"
                        CAPTION(4)   " ~Nง de folhas em relatขrios"
       ...
       300-DIR.
           ...
           PERFORM VARYING RK-CBPAEM FROM 1 BY 1 UNTIL RK-CBPAEM > 3
                   PERFORM TEST AFTER UNTIL FS-CBPAEM NOT = "9D"
                           READ CBPAEM
                           IF   FS-CBPAEM = "9D"
                                CALL "CWISAM" USING ER-CBPAEM
                           END-IF
       ...
       500-TEXTOS.
           ...
           PERFORM UNTIL CAMPO > 2
                   ...
                   ELSE
                       DISPLAY "อออออออออออ" LINE 16 COLUMN 14
                   END-IF
                   EVALUATE CAMPO
